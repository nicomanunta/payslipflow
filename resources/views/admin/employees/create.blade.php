<x-app-layout>
    <div class="container  position-relative">
        <div class="row ">
            <div class="col-12">
                <h1 class="text-uppercase montserrat-bold dark-grey text-shadow-grey text-center my-4">Crea profilo di un dipendente</h1>
            </div>
            <div class="col-12 mx-3">
                ...
                <form action="{{route('admin.employees.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="employee_name" id="employee_name" placeholder="Nome" value="{{ old('employee_name')}}" required>
                        @error('employee_name')
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="employee_surname" id="employee_surname" placeholder="Cognome" value="{{ old('employee_surname')}}" required>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="employee_email" id="employee_email" placeholder="Email" value="{{ old('employee_email')}}" required>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="tel" name="employee_phone" id="employee_phone" placeholder="Telefono" value="{{ old('employee_phone')}}" required>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="employee_state" id="employee_state" placeholder="Paese" value="{{ old('employee_state')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="employee_region" id="employee_region" placeholder="Regione" value="{{old('employee_region')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="employee_city" id="employee_city" placeholder="Comune" value="{{old('employee_city')}}">
                        @error('employee_city')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="date" name="employee_birth_date" id="employee_birth_date" placeholder="Data di nascita" value="{{old('employee_birth_date')}}" required>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="employee_role" id="employee_role" placeholder="Posizione lavorativa" value="{{old('employee_role')}}" required>
                        @error('employee_role')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="date" name="employee_hiring_date" id="employee_hiring_date" placeholder="Data di assunzione" value="{{old('employee_hiring_date')}}" required>
                    ...
                    <div class="form-group mt-3 mb-5">
                        ...
                        <input class="form-control border-steel-blue long-input" type="file" name="employee_img" id="employee_img" placeholder="Foto" accept="image/*" >
                        @error('employee_img')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
