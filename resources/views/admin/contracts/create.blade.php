<x-app-layout>
    <div class="container position-relative">
        <div class="row">
            <div class="col-12">
                <h1 class="text-uppercase montserrat-bold dark-grey text-shadow-grey text-center my-4">Crea il contratto di {{$employee->employee_name}} {{$employee->employee_surname}}</h1>
            </div>
            <div class="col-12 mx-3">
                ...
                <form action="{{route('admin.contracts.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="contract_name" id="contract_name" placeholder="Nome | es. CCNL Metalmeccanico" value="{{old('contract_name')}}" required>
                        @error('contract_name')
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="text" name="contract_level" id="contract_level" placeholder="Livello del contratto" value="{{old('contract_level')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="number" name="contract_gross_monthly_salary" id="contract_gross_monthly_salary" placeholder="Retribuzione mensile lorda" step="0.01" min="0" value="{{old('contract_gross_monthly_salary')}}" required>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="number" name="contract_week_hours" id="contract_week_hours" placeholder="Ore settimanali" min="0" value="{{old('contract_week_hours')}}" required>
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="number" name="contract_vacation_days" id="contract_vacation_days" placeholder="Numero di ferie annuali" step="1" min="0" value="{{old('contract_vacation_days')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="number" name="contract_surcharge_regional" id="contract_surcharge_regional" placeholder="Percentuale addizionale Regionale" step="0.01" min="0" max="100" value="{{old('contract_surcharge_regional')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="number" name="contract_surcharge_municipal" id="contract_surcharge_municipal" placeholder="Percentuale addizionale Comunale " step="0.01" min="0" max="100" value="{{old('contract_surcharge_municipal')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input class="form-control border-steel-blue long-input" type="date" name="contract_start_date" id="contract_start_date" placeholder="Data inizio" value="{{old('contract_start_date')}}" required>
                    ...
                    {{--contract_end_date--}}
                    <div class="form-group my-3">
                        <label class="my-1 roboto-regular medium-grey text-shadow-blue" for="contract_end_date">Data fine</label>
                        <input class="form-control border-steel-blue long-input" type="date" name="contract_end_date" id="contract_end_date" placeholder="Data fine" value="{{old('contract_end_date')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="number" class="form-control border-steel-blue long-input" name="dependent_family_members" id="dependent_family_members" placeholder="Numero di familiari a carico" value="{{old('dependent_family_members')}}">
                    ...
                    <div class="form-group mt-3 mb-5">
                        ...
                        <input type="number" class="form-control border-steel-blue long-input" name="dependent_children_under_24" id="dependent_children_under_24" placeholder="Numero di figli a carico under 24 " value="{{old('dependent_children_under_24')}}">
