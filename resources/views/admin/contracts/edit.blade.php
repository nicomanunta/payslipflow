            ...
            <div class="col-12">
                ...
                <form action="{{route('admin.contracts.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="contract_inps_tax" id="contract_inps_tax" placeholder="Percentuale aliquota INPS" step="0.01" min="0" max="100" value="{{old('contract_inps_tax', $contract->contract_inps_tax)}}">
